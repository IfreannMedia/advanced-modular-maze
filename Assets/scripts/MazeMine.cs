...
public class MapLocationMine
{
    public int x;
    public int z;

    public MapLocationMine(int _x, int _z)
    {
        x = _x;
        z = _z;
    }
...
public class MazeMine : MonoBehaviour
{
    public List<MapLocationMine> directions = new List<MapLocationMine>() {
                                            new MapLocationMine(1,0),
                                            new MapLocationMine(0,1),
                                            new MapLocationMine(-1,0),
                                            new MapLocationMine(0,-1) };
    ...
    private List<MapLocationMine> pillarLocations = new List<MapLocationMine>();
    ...
    private void PlaceWalkablePiece(int x, int z, Vector3 pos)
    {
        ...
        else if (!PositionOnMapEdge(x, z) && ShouldAddRoomFloorPiece(x, z))
        {
            ...
            if (ShouldAddWallTop(x, z))
            {
                ...
                wall.name = "wall-top";
                if (map[x + 1, z] == 0 && map[x + 1, z + 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x, z)))
                {
                    ...
                    pillarLocations.Add(new MapLocationMine(x, z));
                }
                if (map[x - 1, z] == 0 && map[x - 1, z + 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x - 1, z)))
                {
                    plr = Instantiate(pillar.prefab);
                    plr.transform.position = new Vector3((x - 1) * scale, 0, z * scale);
                    plr.transform.localScale = new Vector3(1.01f, 1.00f, 1.01f);
                    plr.name = "pillar-top-left";
                    pillarLocations.Add(new MapLocationMine(x - 1, z));
                }
            }
            if (ShouldAddWallLeft(x, z))
            {
                ...
                wall.name = "wall-left";
                if (map[x, z + 1] == 0 && map[x - 1, z + 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x - 1, z)))
                {
                    plr = Instantiate(pillar.prefab);
                    plr.transform.position = new Vector3((x - 1) * scale, 0, z * scale);
                    plr.transform.localScale = new Vector3(1.01f, 1.00f, 1.01f);
                ...
                if (map[x, z - 1] == 0 && map[x - 1, z - 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x - 1, z - 1)))
                {
                    plr = Instantiate(pillar.prefab);
                    plr.transform.position = new Vector3((x - 1) * scale, 0, (z - 1) * scale);
                    plr.transform.localScale = new Vector3(1.01f, 1.00f, 1.01f);
                    plr.name = "pillar-left-bottom";
                    pillarLocations.Add(new MapLocationMine(x - 1, z - 1));
                }
            }
            if (ShouldAddWallRight(x, z))
            {
                ...
                if (map[x, z + 1] == 0 && map[x + 1, z + 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x, z)))
                {
                    plr = Instantiate(pillar.prefab);
                    plr.transform.position = new Vector3(x * scale, 0, z * scale);
                    plr.transform.localScale = new Vector3(1.01f, 1.00f, 1.01f);
                ...
                if (map[x, z - 1] == 0 && map[x + 1, z - 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x, z - 1)))
                {
                    plr = Instantiate(pillar.prefab);
                    plr.transform.position = new Vector3(x * scale, 0, (z - 1) * scale);
                    plr.transform.localScale = new Vector3(1.01f, 1.00f, 1.01f);
                    plr.name = "pillar-right-bottom";
                    pillarLocations.Add(new MapLocationMine(x, z - 1));
                }
            }
            if (ShouldAddWallBottom(x, z))
            {
                ...
                if (map[x + 1, z] == 0 && map[x + 1, z - 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x, z - 1)))
                {
                    plr = Instantiate(pillar.prefab);
                    plr.transform.position = new Vector3(x * scale, 0, (z - 1) * scale);
                    plr.transform.localScale = new Vector3(1.01f, 1.00f, 1.01f);
                ...
                if (map[x - 1, z] == 0 && map[x - 1, z - 1] == 0 && !pillarLocations.Contains(new MapLocationMine(x - 1, z - 1)))
                {
                    plr = Instantiate(pillar.prefab);
                    plr.transform.position = new Vector3((x - 1) * scale, 0, (z - 1) * scale);
                    plr.transform.localScale = new Vector3(1.01f, 1.00f, 1.01f);
